...
@section('content')
    <script>
        var baseUrl = "<?= URL( '/' ) ?>/applications/kralik";
    </script>
    <style>
        #container{
    ...
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/three.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/TrackballControls.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/OrbitControls.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/OBJLoader.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/Detector.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/MTLLoader.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/OBJMTLLoader.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/ImageUtils.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/jquery.min.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/jquery.flot.js"></script>
    <script src="<?= URL::to( '/' ); ?>/applications/kralik/kniznice/FresnelShader.js"></script>
    <script>
    ...
    // This <div> will host the canvas for our scene.
        ...
        var texture = THREE.ImageUtils.loadTexture(baseUrl+"/voda.jpg");//, {}, function() {renderer.render(scene);});


        var urls = [
                baseUrl+'/skybox/posx.jpg',
                baseUrl+'/skybox/negx.jpg',
                baseUrl+'/skybox/posy.jpg',
                baseUrl+'/skybox/negy.jpg',
                baseUrl+'/skybox/posz.jpg',
                baseUrl+'/skybox/negz.jpg'
        ],
        ...
        var valecMaterial = new THREE.MeshPhongMaterial( {map: THREE.ImageUtils.loadTexture(baseUrl+'/voda.jpg') } );
        ...
        var fresnelUniforms =
        {
        "texture": { type: "t", value: THREE.ImageUtils.loadTexture( baseUrl+"/voda.jpg" ) },
        ...
        customMaterial.bumpMap = THREE.ImageUtils.loadTexture(baseUrl+'/7718-bump11smart.png');
        ...
        loader.load( baseUrl+'/objekty2/zaklad.obj',baseUrl+'/objekty2/zaklad.mtl', function ( event ) {
        var object = event;
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/brushed_aluminium_texture512_2.jpg');
        ...
        loader.load( baseUrl+'/objekty2/nadrz.obj',baseUrl+'/objekty2/nadrz.mtl', function ( event ) {
        var object = event;
        //object.traverse( function ( child ) {
        // if ( child instanceof THREE.Mesh ) {
        //		child.material = sklo;
        ...
        loader.load( baseUrl+'/objekty2/noha.obj',baseUrl+'/objekty2/noha.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.scale = new THREE.Vector3( 25, 25, 25 );
        //object.position.set(0.22609+0.18, -0.75982, 0.55816);
        ...
        loader.load( baseUrl+'/objekty2/valec.obj',baseUrl+'/objekty2/valec.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/odmerka.jpg');
        var textura2=THREE.ImageUtils.loadTexture(baseUrl+'/textury/odmerka_alpha2.jpg');
        ...
        loader.load( baseUrl+'/objekty2/hadicky.obj',baseUrl+'/objekty2/hadicky.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.scale = new THREE.Vector3( 25, 25, 25 );
        //object.position.set(0.22609+0.18, -0.75982, 0.55816);
        ...
        loader.load( baseUrl+'/objekty2/plc_low.obj',baseUrl+'/objekty2/plc_low.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.scale = new THREE.Vector3( 25, 25, 25 );
        //object.position.set(0.22609+0.18, -0.75982, 0.55816);
        ...
        loader.load( baseUrl+'/objekty2/plc_inv.obj',baseUrl+'/objekty2/plc_inv.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.scale = new THREE.Vector3( 25, 25, 25 );
        //object.position.set(0.22609+0.18, -0.75982, 0.55816);
        ...
        loader.load( baseUrl+'/objekty2/pumpa_low.obj',baseUrl+'/objekty2/pumpa_low.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.scale = new THREE.Vector3( 25, 25, 25 );
        //object.position.set(0.22609+0.18, -0.75982, 0.55816);
        ...
        loader.load( baseUrl+'/objekty2/uchytka.obj',baseUrl+'/objekty2/uchytka.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.scale = new THREE.Vector3( 25, 25, 25 );
        //object.position.set(0.22609+0.18, -0.75982, 0.55816);
        ...
        loader2.load( baseUrl+'/objekty2/voda.obj', function ( event ) {
        valec_1 = event;
        ...
        loader.load( baseUrl+'/objekty/plc s.obj',baseUrl+'/objekty/plc s.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.scale = new THREE.Vector3( 25, 25, 25 );
        object.position.set(0.22609+0.18, -0.75982, 0.55816);
        ...
        loader.load( baseUrl+'/objekty/stena.obj',baseUrl+'/objekty/stena.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        //stredna dolna
        loader.load( baseUrl+'/objekty/uchytka_low.obj',baseUrl+'/objekty/uchytka_low.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        //lava dolna
        loader.load( baseUrl+'/objekty/uchytka sd.obj',baseUrl+'/objekty/uchytka sd.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/zlatarura l.obj',baseUrl+'/objekty/zlatarura l.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/zlatarura s.obj',baseUrl+'/objekty/zlatarura s.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/zlaty_ohyb.obj',baseUrl+'/objekty/zlaty_ohyb.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/valec velky.obj',baseUrl+'/objekty/valec velky.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/koniec_str_m.obj',baseUrl+'/objekty/koniec_str_m.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/koniec_str_v.obj',baseUrl+'/objekty/koniec_str_v.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/rurka_nova.obj',baseUrl+'/objekty/rurka_nova.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        loader.load( baseUrl+'/objekty/cierny_valec.obj',baseUrl+'/objekty/cierny_valec.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        ...
        loader.load( baseUrl+'/objekty/hadicky.obj',baseUrl+'/objekty/hadicky.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        //stredny
        loader.load( baseUrl+'/objekty/valec stredny.obj',baseUrl+'/objekty/valec stredny.mtl', function ( event ) {
        var object = event;
        object.name="sustava";
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        //VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA  VODA
        loader2.load( baseUrl+'/objekty/valec.obj', function ( event ) {
        valec_1 = event;
        valec_1.name="sustava";
        valec_1.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        ...
        scene.add(skybox);
        loader.load( baseUrl+'/objekty2/stol.obj',baseUrl+'/objekty2/stol.mtl', function ( event ) {
        var object = event;
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh ) {
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/wood-texture1024.jpg');
        ...
        loader.load( baseUrl+'/objekty2/komnata.obj',baseUrl+'/objekty2/komnata.mtl', function ( event ) {
        var object = event;
        var s=0;
        object.traverse( function ( child ) {
        ...
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/wood_roof1024.jpg');
        textura.wrapS=textura.wrapT=THREE.RepeatWrapping;
        ...
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/castle_wall1024.jpg');
        var textura2=THREE.ImageUtils.loadTexture(baseUrl+'/textury/castle_wall1024bump.jpg');
        textura.wrapS=textura.wrapT=THREE.RepeatWrapping;
        ...
        loader.load( baseUrl+'/objekty2/strecha.obj',baseUrl+'/objekty2/strecha.mtl', function ( event ) {
        var object = event;
        var s=0;
        object.traverse( function ( child ) {
        //child.material=stena;
        ...
        if ( child instanceof THREE.Mesh && s>3) {
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/roof texture 1.jpg');
        textura.wrapS=textura.wrapT=THREE.RepeatWrapping;
        ...
        loader.load( baseUrl+'/objekty2/miestnost3.obj',baseUrl+'/objekty2/miestnost3.mtl', function ( event ) {
        var object = event;
        var s=0;
        object.traverse( function ( child ) {
        if ( child instanceof THREE.Mesh && s==4) {
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/wood-flooring1024.jpg');
        textura.wrapS=textura.wrapT=THREE.RepeatWrapping;
        ...
        if ( child instanceof THREE.Mesh && s==3) {
        var textura=THREE.ImageUtils.loadTexture(baseUrl+'/textury/white_paint_stucco.jpg');
        textura.wrapS=textura.wrapT=THREE.RepeatWrapping;
        textura.repeat.set(10,10);
        child.material.map = textura;
        child.material.bumpMap = textura;
