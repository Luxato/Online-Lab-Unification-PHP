                ...
                <div class="col-md-12 well text-center">
                    ...
                    <div class="col-lg-6 col-lg-offset-3">
                        <div class="form-group">
                            <input id="title-input" class="form-control" name="title" type="text" placeholder="Jazyk napr. Slovenčina">
                        </div>
                        <div class="form-group">
                            <input id="url-input" class="form-control" name="url" type="text" placeholder="Skratka jazyka napr. sk">
                        </div>
