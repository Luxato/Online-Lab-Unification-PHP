model HydraulikaPIDq1
  ...
  constant Real ref = 15 "Reference level";
  Real q1(start=0) "pritok1";
  Real h1(start=10, fixed=true) "vyska1";
  Real h2(start=10, fixed=true) "vyska2";
  Real h3(start=10, fixed=true) "vyska3";
  //PID controller part
  ...
  //parameter Real ref = 15 "Reference level";
